function [visualiseNodesData, dependencyVisData] = skelHierarchicalSeparate(skelFile, animFile)

% SELHIERARCHICALSEPARATE Run a given data set in the hierarchical GP-LVM.
% FORMAT
